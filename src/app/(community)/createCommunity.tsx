...
import { createCommunity, getAllCommunityTypes } from '../../apis/communityService'
...
const CommunityTypeScreen = () => {
  ...
  const fetchData = async () => {
    try {
      const data = await getAllCommunityTypes()
      setDataType(data || [])
    } catch (error: any) {
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          Decide who can view and contribute in your community. Only public communities show up in
          search.
        </Text>
